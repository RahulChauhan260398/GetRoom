<div class="cover_area">
  ...
  <div class="cover_main container">
    <div class="cover_inner">
      <div class="title">
        <h1 class="text-center">Search Room Here</h1>
      </div>
      <div class="search_area">
        <div class="search_main">
          <form class="search_cover" action="availablehouse.php" method="get">
            <div class="address_cover">
              <input type="text" name="address" class="form-control" value="" placeholder="Address" style="border-radius:24px;">
            </div>
            <div class="rent_type">
            ...
            <div id="range_cover">
              ...
              <input type="text" id="input_range_cover" name="rental_value" readonly style="border:0; color:#398a73; font-weight:bold;">
