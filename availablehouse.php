      ...
      <div class="search_house_inner card">
        <div class="well search_card card-body">
          <form class="search_house_form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <input type="text" name="address" class="form-control" style="border-radius:24px;" value="<?php if(isset($_POST['address'])){
              echo $_POST['address'];
            } ?>" placeholder="Address">
            <select class="form-control" style="background-color:lavender; border-radius:24px;" name="house_type">
            ...
            <div id="range">
              ...
              <input type="text" id="input_range" name="rental_value" readonly style="border:0; color:#398a73; font-weight:bold;">
...
<?php
 ...
 $(function(){
   $( "#main_range" ).slider({
    ...
    $( "#input_range" ).val("$" + $( "#main_range" ).slider( "values", 0 ) + " - $" + $( "#main_range" ).slider( "values", 1 ) );
   });  
 </script>
