    ...
    public function updateUser($id,$data,$files)
    {
      ...
      if(isset($files['profile_img'] ) && $files['profile_img']['name'] != '') {
          ...
          if ($file_size>(10*1024*1024)){
              ...
              $sql = "update tbl_user set fname=:fname, lname=:lname, address=:address, phone_number=:phone_number, nid=:nid,upi_id=:upi_id, description=:description,pic=:pic where id=:id";
              $query = $this->db->link->prepare($sql);
              ...
              $query->bindParam('upi_id',$data['upi_id'],PDO::PARAM_STR);
        ...
        print_r($id);
        print_r($files);
        $sql = "update tbl_user set fname=:fname, lname=:lname, address=:address, phone_number=:phone_number, nid=:nid,upi_id=:upi_id, description=:description where id=:id";
        $query = $this->db->link->prepare($sql);
        $query->bindParam('fname',$data['fname'],PDO::PARAM_STR);
        $query->bindParam('lname',$data['lname'],PDO::PARAM_STR);
        $query->bindParam('address',$data['address'],PDO::PARAM_STR);
